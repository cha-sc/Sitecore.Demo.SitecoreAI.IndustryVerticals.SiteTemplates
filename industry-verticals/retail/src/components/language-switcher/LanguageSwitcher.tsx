    ...
    <div className={`component language-switcher ${styles}`} id={id}>
      <Select value={selectedLocale} onValueChange={(value) => changeLanguage(value as string)}>
        <SelectTrigger
          ...
          className="border-0 shadow-none [&>svg]:hidden [.component.header_&]:px-1 [.component.header_&]:text-background"
        >
          <div className="flex items-center gap-2">
            <Globe className="size-5 [.component.header_&]:text-background" />
